...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { description: @artwork.description, name: @artwork.name, picture: @artwork.picture, row_order: @artwork.row_order }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { description: @artwork.description, name: @artwork.name, picture: @artwork.picture, row_order: @artwork.row_order }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
